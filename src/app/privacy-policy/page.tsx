  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 p-8">
      ...
      <p>
        ...
        privacy of individuals who visit our website, engage with our services,
        or participate in our knowledge-sharing community. This Privacy Policy
      ...
      <ul className="list-inside list-disc space-y-2">
        <li>
          ...
          <ul className="list-disc space-y-1 pl-6">
            <li>
              <strong>Identifiers:</strong> such as your name and email address.
            </li>
          </ul>
        </li>
        <li>
          ...
          <ul className="list-disc space-y-1 pl-6">
            ...
            <li>
              <strong>Analytics Information:</strong> Pages visited, time spent,
      ...
      <ul className="list-inside list-disc space-y-2">
        <li>
          <strong>Knowledge Sharing:</strong> To enhance and tailor the content
          we provide, ensuring it aligns with our audience’s interests.
        </li>
        <li>
        ...
        <li>
          ...
          organization, events, newsletters, and other relevant information. You
      ...
      <ul className="list-inside list-disc space-y-2">
        <li>
          ...
          hosting, analytics, and email marketing platforms). These partners are
          bound to protect your data and use it only for the intended purpose.
        </li>
        <li>
      ...
      <ul className="list-inside list-disc space-y-2">
        <li>
          ...
          If you wish to do so, please contact us using the details below.
        </li>
        <li>
          <strong>Opt-Out:</strong> If you no longer want to receive
          communications, you can opt out via the unsubscribe link in emails or
          by contacting us.
        </li>
        <li>
      ...
      <p>
        ...
        changes will be posted on this page, and we will notify you by email or
        through our website if required.
      </p>
