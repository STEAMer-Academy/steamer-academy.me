...
export default function Home() {
	return (
		<Layout>
          ...
          <p className="mb-8">STEAMER Academy goes beyond traditional language learning. We strive to ignite students’ curiosity, fostering a love for learning, critical thinking skills, and creativity. Our classes equip them with the communication skills they need to thrive in an increasingly interconnected world.</p>
