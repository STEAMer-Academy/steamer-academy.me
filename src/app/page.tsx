            ...
            <div>
              ...
              <div className="text-center">
                <Link href="https://discord.gg/Kqpbawj9KU" passHref>
                  <div className="space-y-6">
                    <Button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 w-[48px]">
