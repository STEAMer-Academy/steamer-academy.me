    ...
    <Layout>
      <div className="space-y-6">
          ...
          <div className="relative mx-auto h-full w-full max-w-7xl px-4 md:h-[40rem]">
            <div>
              ...
              <p className="mx-auto mb-8 mt-2 max-w-md text-center text-base font-normal text-neutral-700 dark:text-neutral-200 md:text-lg">
                A vibrant community dedicated to inspiring, educating, and supporting the next generation of leaders in Science, Technology, Engineering, Arts, and Math.
              </p>
        ...
        <section className="container mx-auto mt-5 px-4 pt-8">
          ...
          <p className="mb-8">
            At STEAMer Academy, we’re building a vibrant community where students can explore the limitless opportunities within 
            Science, Technology, Engineering, Arts, and Mathematics. 
            Our mission is simple: to ignite curiosity, foster creativity, and empower learners to solve real-world challenges through innovation and collaboration.
          </p>
        ...
        <section className="container mx-auto px-4">
          ...
          <p className="mb-8">
            We provide a dynamic platform filled with resources, projects, and opportunities to develop practical skills and theoretical knowledge. 
            From coding and robotics to art and engineering, we encourage students to connect their passions with purpose and turn ideas into impactful creations. 
            Learning at STEAMer Academy goes beyond textbooks. 
            It’s about discovering your potential, exploring exciting fields, and working with peers who share your passion for growth. 
            Whether you’re a budding scientist, an aspiring engineer, or a curious learner eager to explore, there’s a place for you here.
          </p>
