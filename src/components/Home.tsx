			...
			<div className="space-y-6">
				<div className="flex flex-row items-center justify-center py-20 h-screen md:h-auto relative w-full">
					<div className="max-w-7xl mx-auto w-full relative h-full md:h-[40rem] px-4">
						...
						>
							...
							<center>
								<Link href="https://discord.gg/Kqpbawj9KU" passHref>
									<Button className="mt-3 mb-6 inline-flex h-12 animate-shimmer items-center justify-center rounded-md border border-slate-800 bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] bg-[length:200%_100%] px-6 font-medium text-slate-400 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
										Get Started
									</Button>
								</Link>
							</center>
						...
						<div className="w-full -bottom-20 h-[30vh] md:h-full z-10">
